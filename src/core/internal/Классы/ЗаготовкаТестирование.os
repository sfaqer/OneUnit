...
Перем _КаталогиТестов;      // Массив из Строка - Каталоги поиска файлов тестовых наборов
Перем _ФайлыТестов;         // Массив из Строка - Пути к файлам тестовых наборов
Перем _ИскатьВПодкаталогах; // Булево - Искать файлы наборов в подкаталогах
...
Процедура ПриИнициализацииПоделки(Поделка) Экспорт
	...
	Для каждого Тест Из ФайлыТестов Цикл
		...
		Путь          = Тест.ПолноеИмя;
		ТестовыйНабор = ТестированиеСлужебный.ИмяКлассаТестовогоНабора(Тест.ИмяБезРасширения);
